...
public class QuestionNo5a {
    ...
    public QuestionNo5a(double[][] distances, int numAnts, double decay, double alpha, double beta) {
    ...
    public static void main(String[] args) {
        ...
        QuestionNo5a antColony = new QuestionNo5a(distances, numAnts, decay, alpha, beta);
