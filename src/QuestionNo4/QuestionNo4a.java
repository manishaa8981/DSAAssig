...
public class QuestionNo4a {
    ...
    public static int collectAllKeys(String[] grid) {
        ...
        while (!queue.isEmpty()) {
            ...
            // All keys collected, return the steps
...
// All possible moves explored and keys not collected, return -1
        return -1;
    }

    public static void main(String[] args) {
        String[] grid1 = { "SPaPP", "WWWPW", "bPAPB" };
        System.out.println("Minimum number of moves: " + collectAllKeys(grid1)); // Output:8
    }
